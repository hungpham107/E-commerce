        ...
        <div className="mt-8">
          ...
          <div className="flex justify-between flex-wrap p-8 bg-[#181818]">
            <ul className="text-lg">
              <li>
                <span className="font-semibold mb-4 text-white">Items:</span>
                <span className="text-white">${cart.itemsPrice}</span>
              </li>
              <li>
                <span className="font-semibold mb-4 text-white">Shipping:</span>
                <span className="text-white">${cart.shippingPrice}</span>
              </li>
              <li>
                <span className="font-semibold mb-4 text-white">Tax:</span>
                <span className="text-white">${cart.taxPrice}</span>
              </li>
              <li>
                <span className="font-semibold mb-4 text-white">Total:</span>
